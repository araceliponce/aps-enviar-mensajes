...
import { SendMethod, sendMethodOptions, SendMethodKey } from "@/utils/send_methods";
      ...
      <Dialog>
        <div className="ms-auto w-fit">
          ...
          <div className="btn__feedback">
            {selectedPeople.length > 0 ? `Seleccionados ${selectedPeople.length}` : `Selecciona al menos 1`}
